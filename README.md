...
Drafts are checked against 27 named AI writing anti-patterns, each with symptoms,
...
Every rewrite is re-audited against all 27 patterns before it's considered fixed.
