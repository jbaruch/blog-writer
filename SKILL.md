...
2. **Follow the three-pass procedure exactly as written in `references/process.md`.** Pass 1
   is the surface scan against all 27 patterns. Pass 2 is the skeleton scan on adjacent
...
3. **Do not invent patterns that aren't in the file.** If something feels "AI-ish" but
   doesn't match any of the 27 defined patterns or their structural variants, leave it
